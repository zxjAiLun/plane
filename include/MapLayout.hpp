...
struct MapLayoutDefinition {
    ...
    Vector2 encounterPosition;
};

class MapLayoutLibrary {
public:
    static constexpr int TemplateCount = 4;
            ...
            {
                {
                    "frostbound-pass-0",
                    {
                        {{660.0f, 1360.0f}, {130.0f, 70.0f}},
                        {{980.0f, 1130.0f}, {90.0f, 150.0f}},
                        {{1320.0f, 780.0f}, {150.0f, 70.0f}},
                        {{1650.0f, 620.0f}, {90.0f, 130.0f}},
                        {{1850.0f, 940.0f}, {70.0f, 70.0f}},
                    },
                    {{700.0f, 1100.0f}, {1200.0f, 980.0f}, {1450.0f, 470.0f}},
                    {1030.0f, 720.0f}
                },
                {
                    "frostbound-pass-1",
                    {
                        {{560.0f, 1280.0f}, {110.0f, 60.0f}},
                        {{900.0f, 980.0f}, {80.0f, 150.0f}},
                        {{1240.0f, 1220.0f}, {140.0f, 65.0f}},
                        {{1510.0f, 760.0f}, {100.0f, 60.0f}},
                        {{1800.0f, 700.0f}, {80.0f, 110.0f}},
                    },
                    {{720.0f, 920.0f}, {1120.0f, 1040.0f}, {1480.0f, 540.0f}},
                    {980.0f, 700.0f}
                },
                {
                    "frostbound-pass-2",
                    {
                        {{620.0f, 1080.0f}, {90.0f, 150.0f}},
                        {{1040.0f, 650.0f}, {150.0f, 60.0f}},
                        {{1450.0f, 1080.0f}, {110.0f, 140.0f}},
                        {{1700.0f, 700.0f}, {100.0f, 60.0f}},
                        {{1880.0f, 1120.0f}, {60.0f, 110.0f}},
                    },
                    {{800.0f, 1320.0f}, {1000.0f, 1000.0f}, {1510.0f, 500.0f}},
                    {1280.0f, 820.0f}
                },
            },
        };
