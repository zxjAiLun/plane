...
private:
    ...
    static std::vector<ItemBaseDefinition> buildBases() {
        return {
            ...
            {"boss.cinderheart-core", "Cinderheart Core", EquipmentSlot::Ring,
                makeStats(6, 1.0f, 1.02f, 1.0f, 1.0f, 1.0f, 1.0f, 1.10f),
                    ItemBaseKind::BossRelic, ItemBaseTheme::Brimstone, 1,
                    ItemBuildTheme::Fire, 2},
            ...
            {"boss.stormglass-lens", "Stormglass Lens", EquipmentSlot::Amulet,
                makeStats(8, 1.0f, 1.0f, 1.04f, 1.0f, 1.10f),
                    ItemBaseKind::BossRelic, ItemBaseTheme::Storm, 1,
                    ItemBuildTheme::Projectile, 2},
            ...
            {"boss.permafrost-diadem", "Permafrost Diadem", EquipmentSlot::Amulet,
                makeStats(10, 1.0f, 1.0f, 1.03f, 1.0f, 1.0f, 1.05f, 1.10f),
                    ItemBaseKind::BossRelic, ItemBaseTheme::Frost, 1,
                    ItemBuildTheme::Cold, 2},
